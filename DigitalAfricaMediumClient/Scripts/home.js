...
function doBlockAnimations() {
	var i = 0;
	for (i;i<9;i++){
		var rd = getRandomInt(-300,300), rs = getRandomInt(0.1,1), sc = parseFloat(rs*0.5),
...
function openText(){
    var hd = KUTE.to(h2, {text: 'Welcome To Board!'}, {delay: 4500, duration:2000, easing: 'easingCubicInOut'}).start(),
	    ld = KUTE.to(lead, {text: 'No other bulletin board software offers a <strong>greater complement</strong> of features, while maintaining efficiency and ease of use. '}, {duration:4000, easing: 'easingCubicInOut'});
